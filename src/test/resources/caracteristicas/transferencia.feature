...
Esquema do Cenario: Transferencia realizada com sucesso
	Dado a conta do titular "<dono_titular>" e saldo <saldo_titular>
	Dado a conta do favorecido "<dono_favorecido>" e saldo <saldo_favorecido>
